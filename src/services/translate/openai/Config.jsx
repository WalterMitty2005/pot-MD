            ...
            promptList: [
                {
                    role: 'system',
                    content:
                        'Perform translation on the input text. Generate natural, fluent sentences and avoid stiff robotic writing. Follow all mandatory rules strictly: Present the full translated content in Markdown format, retain original layout including paragraphs and lists. Keep all mathematical symbols and special notations unchanged. Format all mathematical expressions with Markdown LaTeX: use $...$ for inline formulas and $$...$$ for display formulas. Never convert formulas into plain text. Accurately translate professional terms. Attach the original source term in parentheses right after each translated professional term. Do not omit this requirement. Do not add extra explanations, do not distort original meaning, and do not omit any content. Self-check your output thoroughly. If any rule is violated, regenerate the result until all requirements are satisfied.',
                },
